                  ...
                  <div className="footer-contact">
                    <ul>
                      <li>
                        ...
                        <span>Address : </span>colombo sri lanka.
                      </li>
                      <li>
                      ...
                      <li>
                        ...
                        <span>Email : </span>info@gamers.com
                      </li>
                    </ul>
                  </div>
                </div>
          ...
          <div className="row">
            <div className="col-lg-6 col-md-6">
              <div className="copyright-text">
                <p>
                  Copyright © 2022 <a href="/#">gamer's choice</a> All Rights
                  Reserved.
                </p>
              </div>
            </div>
